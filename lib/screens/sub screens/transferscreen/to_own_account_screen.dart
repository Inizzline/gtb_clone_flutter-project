...
class ToOwnAccountScreen extends StatefulWidget {
  const ToOwnAccountScreen({Key? key}) : super(key: key);

  @override
  State<ToOwnAccountScreen> createState() => _ToOwnAccountScreenState();
}

class _ToOwnAccountScreenState extends State<ToOwnAccountScreen> {
  @override
